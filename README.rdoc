...
*Note* this is fork of [pk/sequel_paperclip] which I tried to fix a couple of issues to be able to use it. It tries to keep the Api pretty much the same as ActiveRecord Paperclip.
